...
```html
<script src="https://cdn.jsdelivr.net/npm/admin-lte@3.2/adminlte/dist/js/adminlte.min.js"></script>
```
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/admin-lte@3.2/adminlte/dist/css/adminlte.min.css">
```
...
File Location `./adminlte/dist/css/alt/adminlte.light.css`
